<?php
/*
Plugin Name: List Category Posts - Template "Featured"
...
$lcp_display_output .= '<ul class="featured-posts">';
...
foreach ($this->catlist->get_categories_posts() as $single){
  ...
  $lcp_display_output .= '<div class="feature-inner">';
  ...
  //Post Thumbnail
  $lcp_display_output .= '<div class="feature-image">';
   ...
   */
  $lcp_display_output .= $this->get_content($single, 'p', 'feature-content');

  /**
   * Post content - Example of how to use tag and class parameters:
   * This will produce:<div class="lcp_excerpt">The content</div>
   */
  $lcp_display_output .= $this->get_excerpt($single, 'div', 'feature-excerpt');
